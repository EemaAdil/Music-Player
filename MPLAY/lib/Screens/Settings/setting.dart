...
// import 'package:MPLAY/Helpers/countrycodes.dart';
import 'package:MPLAY/Helpers/picker.dart';
import 'package:MPLAY/Helpers/supabase.dart';
import 'package:MPLAY/Screens/Home/saavn.dart' as home_screen;
import 'package:MPLAY/Screens/Settings/player_gradient.dart';
// import 'package:MPLAY/Screens/Trending/top.dart' as top_screen;
...
class _SettingPageState extends State<SettingPage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/MPLAY/Backups',
  ) as String;
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                      ...
                                      '/storage/emulated/0/MPLAY/Backups';
                              Hive.box('settings')
